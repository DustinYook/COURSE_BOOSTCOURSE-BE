...
public class FileController 
{
	...
	public String upload(@RequestParam("file") MultipartFile file)
	{
		...
		fileInfo.setSaveName("C:/Users/aomor/eclipse_ee/guestbook/src/main/resources/tmp/" + file.getOriginalFilename());
		...
		try( FileOutputStream fos = new FileOutputStream("C:/Users/aomor/eclipse_ee/guestbook/src/main/resources/tmp/" + file.getOriginalFilename()); 
	...
	public void download(@RequestParam(name="fileId", required=true) Long fileId, HttpServletResponse response)
	{
		...
		// String saveName = "c:/tmp/connect.png";
